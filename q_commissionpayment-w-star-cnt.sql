WITH q0 as 
	(SELECT /*+ materialize */ DISTINCT (TT.EXTERNALID) 
	FROM BILL TT 
    ...
    (SELECT /*+ materialize */ finopacca.parent_oid, 
 ...
 FINOP_BASE_AND_RATES 
  AS 
    (SELECT /*+ materialize */ PARENT_OID, 
            AMOUNTTYPE_EID, 
            SUBAMOUNTTYPE_EID, 
            BASE_AMOUNT, 
            RATE 
       FROM (SELECT /*+ materialize */ FINANCIALOP_ACCACTIONS.PARENT_OID, 
